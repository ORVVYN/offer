# теперь будем инсайды публиковать вместо маркета Станислав прием как слышно, прием blockchain GiftZaar - Маркетплейс цифровых подарков Telegram с блокчейн-интеграцией
